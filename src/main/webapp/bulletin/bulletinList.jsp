		...
		<table class="list">
			<tr>
				<td colspan="6" style="border: white; text-align: right"><a
					href="OttServlet?command=bulletin_write_form&contentNum=${content.contentNum}">게시글
						등록</a></td>
			</tr>
			<tr>
				<th>번호</th>
			...
			<c:forEach var="bulletin" items="${bulletinList}">
				<c:if test="${content.contentNum == bulletin.contentNum}">
					<tr class="record">
						...
						<td><a
							href="OttServlet?command=bulletin_view&bulletinNum=${bulletin.bulletinNum}&contentNum=${bulletin.contentNum}">
